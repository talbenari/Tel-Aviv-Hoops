...
<div className='combo'>
<img className='images' src="https://indoorhoops.com/img/rules_icons/idh_rules_01-whistle.svg" alt="hoops" />
...
<div className='combo'>
<img className='images' src="https://indoorhoops.com/img/rules_icons/idh_rules_02-score.svg" alt="hoops" />
...
<div className='combo'>
<img className='images' src="https://indoorhoops.com/img/rules_icons/idh_rules_03-trophy.svg" alt="hoops" />
...
<div className='combo'>
<img className='images' src="https://indoorhoops.com/img/rules_icons/idh_rules_04-fighting.svg" alt="hoops" />
...
<div className='combo'>
<img className='images' src="https://indoorhoops.com/img/rules_icons/idh_rules_05-bottle.svg" alt="hoops" />
...
<div className='combo'>
<img className='images' src="https://indoorhoops.com/img/rules_icons/idh_rules_06-clock.svg" alt="hoops" />
...
<div className='combo'>
<img className='images' src="https://indoorhoops.com/img/rules_icons/idh_rules_07-hoop.svg" alt="hoops" />
...
<div className='button-placement'><button className='button'>PLAY A GAME!</button></div>
    </div>
)
}
